...
def handle_aneks(source: str, destination: str, max_n_characters: int, top_n: int, offset: int):
    ...
    speaker = RuTTS(splitter = Splitter(max_n_characters), add_time_to_end = 0.1, length_scale = 1.65)

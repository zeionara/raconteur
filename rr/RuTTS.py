...
class RuTTS(Raconteur):
    def __init__(self, artist: str = 'TeraTTS/natasha-g2p-vits', add_time_to_end = 0.8, length_scale = 1.2, *args, **kwargs):
        self.add_time_to_end = add_time_to_end
        self.length_scale = length_scale
        self.artist = artist

        self.tts = TTS(artist, add_time_to_end = add_time_to_end, save_path = RUTTS_MODEL_PATH)
